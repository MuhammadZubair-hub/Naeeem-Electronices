...
//     <Stack.Screen 
//       name="CEO_GM_Dashboard" 
//       component={RoleGuard(CEO_GM_Dashboard, [Role.CEO, Role.GM])} 
//     />
//     <Stack.Screen 
//       name="RM_ZM_Dashboard" 
//       component={RoleGuard(RM_ZM_Dashboard, [Role.RM, Role.ZM])} 
//     />
//     <Stack.Screen 
//       name="ZM_BR_Dashboard" 
//       component={RoleGuard(ZM_BR_Dashboard, [Role.ZM, Role.BR])} 
//     />
//     <Stack.Screen 
//       name="BR_AVO_Dashboard" 
//       component={RoleGuard(BR_AVO_Dashboard, [Role.BR, Role.AVO])} 
//     />
//     <Stack.Screen 
//       name="AVO_AllCustomers" 
//       component={RoleGuard(AVO_AllCustomers, [Role.AVO])} 
//     />
//     <Stack.Screen 
//       name="BranchList" 
//       component={RoleGuard(BranchList, [Role.CEO, Role.GM, Role.RM, Role.ZM, Role.BR])} 
//     />
//     <Stack.Screen 
//       name="BranchDetail" 
//       component={RoleGuard(BranchDetail, [Role.CEO, Role.GM, Role.RM, Role.ZM, Role.BR])} 
//     />
//     <Stack.Screen 
//       name="BranchPerformance" 
//       component={RoleGuard(BranchPerformance, [Role.CEO, Role.GM, Role.RM, Role.ZM, Role.BR])} 
//     />
//     <Stack.Screen 
//       name="CustomerList" 
//       component={RoleGuard(CustomerList, [Role.CEO, Role.GM, Role.RM, Role.ZM, Role.BR, Role.AVO])} 
//     />
//     <Stack.Screen 
//       name="CustomerDetail" 
//       component={RoleGuard(CustomerDetail, [Role.CEO, Role.GM, Role.RM, Role.ZM, Role.BR, Role.AVO])} 
//     />
//     <Stack.Screen 
//       name="CustomerTransactions" 
//       component={RoleGuard(CustomerTransactions, [Role.CEO, Role.GM, Role.RM, Role.ZM, Role.BR, Role.AVO])} 
//     />
//     <Stack.Screen 
//       name="InvoiceList" 
//       component={RoleGuard(InvoiceList, [Role.CEO, Role.GM, Role.RM, Role.ZM, Role.BR, Role.AVO])} 
//     />
//     <Stack.Screen 
//       name="InvoiceDetail" 
//       component={RoleGuard(InvoiceDetail, [Role.CEO, Role.GM, Role.RM, Role.ZM, Role.BR, Role.AVO])} 
//     />
//     <Stack.Screen 
//       name="NewSale" 
...
//       component={RoleGuard(BranchComparison, [Role.CEO, Role.GM, Role.RM, Role.ZM])} 
//     />
//     <Stack.Screen 
//       name="StaffPerformance" 
//       component={RoleGuard(StaffPerformance, [Role.CEO, Role.GM, Role.RM, Role.ZM, Role.BR])} 
//     />
//     <Stack.Screen 
//       name="RevenueTrends" 
//       component={RoleGuard(RevenueTrends, [Role.CEO, Role.GM, Role.RM, Role.ZM, Role.BR])} 
//     />
//     <Stack.Screen 
//       name="RecoveryReport" 
//       component={RoleGuard(RecoveryReport, [Role.CEO, Role.GM, Role.RM, Role.ZM, Role.BR])} 
//     />
//   </Stack.Navigator>
// );
